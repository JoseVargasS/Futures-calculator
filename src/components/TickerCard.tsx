...
export function TickerCard({ exchange, market, price, changePct }: Props) {
  ...
  return (
    <section className="flex items-center justify-between rounded-xl border border-binanceBorder bg-binanceCard p-4 shadow-lg">
      <div>
        <span className="block text-[11px] font-medium uppercase tracking-wider text-gray-400">Precio Live {exchange} — {market}</span>
